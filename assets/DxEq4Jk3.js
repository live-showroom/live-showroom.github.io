 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sn(t){return JSON.parse(t)}function Z(t){return JSON.stringify(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gg{constructor(e,n,i,s){this.eventType=e,this.eventRegistration=n,this.snapshot=i,this.prevName=s}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Z(this.snapshot.exportVal())}}class Kg{constructor(e,n,i){this.eventRegistration=e,this.error=n,this.path=i}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ys=new Map,$l={activated:!1,tokenObservers:[]},hm={initialized:!1,enabled:!1};function ee(t){return ys.get(t)||Object.assign({},$l)}function fm(t,e){return ys.set(t,e),ys.get(t)}function Ii(){return hm}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function To(t=!1){var e;return t?(e=self.grecaptcha)===null||e===void 0?void 0:e.enterprise:self.grecaptcha}function vr(t){if(!ee(t).activated)throw de.create("use-before-activation",{appName:t.name})}function Wl(t){const e=Math.round(t/1e3),n=Math.floor(e/(3600*24)),i=Math.floor((e-n*3600*24)/3600),s=Math.floor((e-n*3600*24-i*3600)/60),r=e-n*3600*24-i*3600-s*60;let o="";return n&&(o+=Bn(n)+"d:"),i&&(o+=Bn(i)+"h:"),o+=Bn(s)+"m:"+Bn(r)+"s",o}function Bn(t){return t===0?"00":t>=10?t.toString():"0"+t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yr({url:t,body:e},n){const i={"Content-Type":"application/json"},s=n.getImmediate({optional:!0});if(s){const d=await s.getHeartbeatsHeader();d&&(i["X-Firebase-Client"]=d)}const r={method:"POST",body:JSON.stringify(e),headers:i};let o;try{o=await fetch(t,r)}catch(d){throw de.create("fetch-network-error",{originalErrorMessage:d==null?void 0:d.message})}if(o.status!==200)throw de.create("fetch-status-error",{httpStatus:o.status});let a;try{a=await o.json()}catch(d){throw de.create("fetch-parse-error",{originalErrorMessage:d==null?void 0:d.message})}const l=a.ttl.match(/^([\d.]+)(s)$/);if(!l||!l[2]||isNaN(Number(l[1])))throw de.create("fetch-parse-error",{originalErrorMessage:`ttl field (timeToLive) is not in standard Protobuf Duration format: ${a.ttl}`});const c=Number(l[1])*1e3,u=Date.now();return{token:a.token,expireTimeMillis:u+c,issuedAtTimeMillis:u}}function wm(t,e){const{projectId:n,appId:i,apiKey:s}=t.options;return{url:`${Hl}/projects/${n}/apps/${i}:${pm}?key=${s}`,body:{recaptcha_enterprise_token:e}}}function Ul(t,e){const{projectId:n,appId:i,apiKey:s}=t.options;return{url:`${Hl}/projects/${n}/apps/${i}:${_m}?key=${s}`,body:{debug_token:e}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rm={error:"UNKNOWN_ERROR"};function Pm(t){return hi.encodeString(JSON.stringify(t),!1)}async function ws(t,e=!1){const n=t.app;vr(n);const i=ee(n);let s=i.token,r;if(s&&!Tt(s)&&(i.token=void 0,s=void 0),!s){const l=await i.cachedTokenPromise;l&&(Tt(l)?s=l:await Vi(n,void 0))}if(!e&&s&&Tt(s))return{token:s.token};let o=!1;if(wr()){i.exchangeTokenPromise||(i.exchangeTokenPromise=yr(Ul(n,await Er()),t.heartbeatServiceProvider).finally(()=>{i.exchangeTokenPromise=void 0}),o=!0);const l=await i.exchangeTokenPromise;return await Vi(n,l),i.token=l,{token:l.token}}try{i.exchangeTokenPromise||(i.exchangeTokenPromise=i.provider.getToken().finally(()=>{i.exchangeTokenPromise=void 0}),o=!0),s=await ee(n).exchangeTokenPromise}catch(l){l.code==="appCheck/throttled"?mn.warn(l.message):mn.error(l),r=l}let a;return s?r?Tt(s)?a={token:s.token,internalError:r}:a=Ao(r):(a={token:s.token},i.token=s,await Vi(n,s)):a=Ao(r),o&&Ql(n,a),a}async function xm(t){const e=t.app;vr(e);const{provider:n}=ee(e);if(wr()){const i=await Er(),{token:s}=await yr(Ul(e,i),t.heartbeatServiceProvider);return{token:s}}else{const{token:i}=await n.getToken();return{token:i}}}function Kl(t,e,n,i){const{app:s}=t,r=ee(s),o={next:n,error:i,type:e};if(r.tokenObservers=[...r.tokenObservers,o],r.token&&Tt(r.token)){const a=r.token;Promise.resolve().then(()=>{n({token:a.token}),Io(t)}).catch(()=>{})}r.cachedTokenPromise.then(()=>Io(t))}function Yl(t,e){const n=ee(t),i=n.tokenObservers.filter(s=>s.next!==e);i.length===0&&n.tokenRefresher&&n.tokenRefresher.isRunning()&&n.tokenRefresher.stop(),n.tokenObservers=i}function Io(t){const{app:e}=t,n=ee(e);let i=n.tokenRefresher;i||(i=Om(t),n.tokenRefresher=i),!i.isRunning()&&n.isTokenAutoRefreshEnabled&&i.start()}function Om(t){const{app:e}=t;return new mm(async()=>{const n=ee(e);let i;if(n.token?i=await ws(t,!0):i=await ws(t),i.error)throw i.error;if(i.internalError)throw i.internalError},()=>!0,()=>{const n=ee(e);if(n.token){let i=n.token.issuedAtTimeMillis+(n.token.expireTimeMillis-n.token.issuedAtTimeMillis)*.5+3e5;const s=n.token.expireTimeMillis-5*60*1e3;return i=Math.min(i,s),Math.max(0,i-Date.now())}else return 0},So.RETRIAL_MIN_WAIT,So.RETRIAL_MAX_WAIT)}function Ql(t,e){const n=ee(t).tokenObservers;for(const i of n)try{i.type==="EXTERNAL"&&e.error!=null?i.error(e.error):i.next(e)}catch{}}function Tt(t){return t.expireTimeMillis-Date.now()>0}function Ao(t){return{token:Pm(Rm),error:t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
