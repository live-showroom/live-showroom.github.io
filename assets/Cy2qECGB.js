import Ru from"./B_k5-oSr.js";import{i as Pu,r as w,w as it,a as he,o as Fa,b as Nu,c as Au,d as Ou,g as rr,e as Du,_ as xu,f as V,h as X,j as Mu,k as Lu,l as Ee,F as Bn,m as zt,n as st,p as Gi,q as G,s as xe,t as or,u as Ua,v as Fu,x as Uu,y as vi,z as b,A as Wu,B as Hu,C as L,D as dn,E as mo,G as _e,H as te,I as we,J as Bu,K as Vu,L as $u,M as ht,N as hn,O as ju,T as zu,P as Pt,Q as Gu,R as qu}from"./CxaQlgYB.js";import"./CvPl5tTm.js";function Ku(n,e={}){const t=e.head||Pu();if(t)return t.ssr?t.push(n,e):Yu(t,n,e)}function Yu(n,e,t={}){const i=w(!1),s=w({});it(()=>{s.value=i.value?{}:Ou(e)});const r=n.push(s.value,t);return he(s,a=>{r.patch(a)}),rr()&&(Fa(()=>{r.dispose()}),Nu(()=>{i.value=!0}),Au(()=>{i.value=!1})),r}function Qu(n,e={}){return Ku(n,{...e,transform:Du})}const Ju={},Xu={class:"inline-block",role:"status"},Zu=Mu('<svg class="size-full stroke-white" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g><circle cx="12" cy="12" r="9.5" fill="none" stroke-width="3" stroke-linecap="round"><animate attributeName="stroke-dasharray" dur="1.5s" calcMode="spline" values="0 150;42 150;42 150;42 150" keyTimes="0;0.475;0.95;1" keySplines="0.42,0,0.58,1;0.42,0,0.58,1;0.42,0,0.58,1" repeatCount="indefinite"></animate><animate attributeName="stroke-dashoffset" dur="1.5s" calcMode="spline" values="0;-16;-59;-59" keyTimes="0;0.475;0.95;1" keySplines="0.42,0,0.58,1;0.42,0,0.58,1;0.42,0,0.58,1" repeatCount="indefinite"></animate></circle><animateTransform attributeName="transform" type="rotate" dur="2s" values="0 12 12;360 12 12" repeatCount="indefinite"></animateTransform></g></svg><span class="sr-only">Loading...</span>',2),ed=[Zu];function td(n,e){return V(),X("div",Xu,ed)}const nd=xu(Ju,[["render",td]]);function Le(n,e,...t){if(n in e){let s=e[n];return typeof s=="function"?s(...t):s}let i=new Error(`Tried to handle "${n}" but there is no handler defined. Only defined handlers are: ${Object.keys(e).map(s=>`"${s}"`).join(", ")}.`);throw Error.captureStackTrace&&Error.captureStackTrace(i,Le),i}var xs=(n=>(n[n.None=0]="None",n[n.RenderStrategy=1]="RenderStrategy",n[n.Static=2]="Static",n))(xs||{}),id=(n=>(n[n.Unmount=0]="Unmount",n[n.Hidden=1]="Hidden",n))(id||{});function qi({visible:n=!0,features:e=0,ourProps:t,theirProps:i,...s}){var r;let o=Ha(i,t),a=Object.assign(s,{props:o});if(n||e&2&&o.static)return gs(a);if(e&1){let l=(r=o.unmount)==null||r?0:1;return Le(l,{0(){return null},1(){return gs({...s,props:{...o,hidden:!0,style:{display:"none"}}})}})}return gs(a)}function gs({props:n,attrs:e,slots:t,slot:i,name:s}){var r,o;let{as:a,...l}=sd(n,["unmount","static"]),c=(r=t.default)==null?void 0:r.call(t,i),u={};if(i){let d=!1,h=[];for(let[f,p]of Object.entries(i))typeof p=="boolean"&&(d=!0),p===!0&&h.push(f);d&&(u["data-headlessui-state"]=h.join(" "))}if(a==="template"){if(c=Wa(c??[]),Object.keys(l).length>0||Object.keys(e).length>0){let[d,...h]=c??[];if(!rd(d)||h.length>0)throw new Error(['Passing props on "template"!',"",`The current component <${s} /> is rendering a "template".`,"However we need to passthrough the following props:",Object.keys(l).concat(Object.keys(e)).map(m=>m.trim()).filter((m,C,E)=>E.indexOf(m)===C).sort((m,C)=>m.localeCompare(C)).map(m=>`  - ${m}`).join(`
`),"","You can apply a few solutions:",['Add an `as="..."` prop, to ensure that we render an actual element instead of a "template".',"Render a single element as the child so that we can forward the props onto that element."].map(m=>`  - ${m}`).join(`
`)].join(`
`));let f=Ha((o=d.props)!=null?o:{},l,u),p=Lu(d,f,!0);for(let m in f)m.startsWith("on")&&(p.props||(p.props={}),p.props[m]=f[m]);return p}return Array.isArray(c)&&c.length===1?c[0]:c}return Ee(a,Object.assign({},l,u),{default:()=>c})}function Wa(n){return n.flatMap(e=>e.type===Bn?Wa(e.children):[e])}function Ha(...n){if(n.length===0)return{};if(n.length===1)return n[0];let e={},t={};for(let i of n)for(let s in i)s.startsWith("on")&&typeof i[s]=="function"?(t[s]!=null||(t[s]=[]),t[s].push(i[s])):e[s]=i[s];if(e.disabled||e["aria-disabled"])return Object.assign(e,Object.fromEntries(Object.keys(t).map(i=>[i,void 0])));for(let i in t)Object.assign(e,{[i](s,...r){let o=t[i];for(let a of o){if(s instanceof Event&&s.defaultPrevented)return;a(s,...r)}}});return e}function sd(n,e=[]){let t=Object.assign({},n);for(let i of e)i in t&&delete t[i];return t}function rd(n){return n==null?!1:typeof n.type=="string"||typeof n.type=="object"||typeof n.type=="function"}function P(n){var e;if(n==null||n.value==null)return null;let t=(e=n.value.$el)!=null?e:n.value;return t instanceof Node?t:null}var od=Object.defineProperty,ad=(n,e,t)=>e in n?od(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,go=(n,e,t)=>(ad(n,typeof e!="symbol"?e+"":e,t),t);let ld=class{constructor(){go(this,"current",this.detect()),go(this,"currentId",0)}set(e){this.current!==e&&(this.currentId=0,this.current=e)}reset(){this.set(this.detect())}nextId(){return++this.currentId}get isServer(){return this.current==="server"}get isClient(){return this.current==="client"}detect(){return typeof window>"u"||typeof document>"u"?"server":"client"}},Ki=new ld;function Vn(n){if(Ki.isServer)return null;if(n instanceof Node)return n.ownerDocument;if(n!=null&&n.hasOwnProperty("value")){let e=P(n);if(e)return e.ownerDocument}return document}let vo=Symbol("PortalParentContext");function cd(){let n=zt(vo,null),e=w([]);function t(r){return e.value.push(r),n&&n.register(r),()=>i(r)}function i(r){let o=e.value.indexOf(r);o!==-1&&e.value.splice(o,1),n&&n.unregister(r)}let s={register:t,unregister:i,portals:e};return[e,st({name:"PortalWrapper",setup(r,{slots:o}){return Gi(vo,s),()=>{var a;return(a=o.default)==null?void 0:a.call(o)}}})]}function ud(n,e,t,i){Ki.isServer||it(s=>{n=n??window,n.addEventListener(e,t,i),s(()=>n.removeEventListener(e,t,i))})}let dd=Symbol("headlessui.useid"),hd=0;function yn(){return zt(dd,()=>`${++hd}`)()}let Ms=["[contentEditable=true]","[tabindex]","a[href]","area[href]","button:not([disabled])","iframe","input:not([disabled])","select:not([disabled])","textarea:not([disabled])"].map(n=>`${n}:not([tabindex='-1'])`).join(",");var ke=(n=>(n[n.First=1]="First",n[n.Previous=2]="Previous",n[n.Next=4]="Next",n[n.Last=8]="Last",n[n.WrapAround=16]="WrapAround",n[n.NoScroll=32]="NoScroll",n))(ke||{}),yi=(n=>(n[n.Error=0]="Error",n[n.Overflow=1]="Overflow",n[n.Success=2]="Success",n[n.Underflow=3]="Underflow",n))(yi||{}),fd=(n=>(n[n.Previous=-1]="Previous",n[n.Next=1]="Next",n))(fd||{});function Yi(n=document.body){return n==null?[]:Array.from(n.querySelectorAll(Ms)).sort((e,t)=>Math.sign((e.tabIndex||Number.MAX_SAFE_INTEGER)-(t.tabIndex||Number.MAX_SAFE_INTEGER)))}var ar=(n=>(n[n.Strict=0]="Strict",n[n.Loose=1]="Loose",n))(ar||{});function Ba(n,e=0){var t;return n===((t=Vn(n))==null?void 0:t.body)?!1:Le(e,{0(){return n.matches(Ms)},1(){let i=n;for(;i!==null;){if(i.matches(Ms))return!0;i=i.parentElement}return!1}})}var pd=(n=>(n[n.Keyboard=0]="Keyboard",n[n.Mouse=1]="Mouse",n))(pd||{});typeof window<"u"&&typeof document<"u"&&(document.addEventListener("keydown",n=>{n.metaKey||n.altKey||n.ctrlKey||(document.documentElement.dataset.headlessuiFocusVisible="")},!0),document.addEventListener("click",n=>{n.detail===1?delete document.documentElement.dataset.headlessuiFocusVisible:n.detail===0&&(document.documentElement.dataset.headlessuiFocusVisible="")},!0));let _d=["textarea","input"].join(",");function md(n){var e,t;return(t=(e=n==null?void 0:n.matches)==null?void 0:e.call(n,_d))!=null?t:!1}function gd(n,e=t=>t){return n.slice().sort((t,i)=>{let s=e(t),r=e(i);if(s===null||r===null)return 0;let o=s.compareDocumentPosition(r);return o&Node.DOCUMENT_POSITION_FOLLOWING?-1:o&Node.DOCUMENT_POSITION_PRECEDING?1:0})}function ft(n,e,{sorted:t=!0,relativeTo:i=null,skipElements:s=[]}={}){var r;let o=(r=Array.isArray(n)?n.length>0?n[0].ownerDocument:document:n==null?void 0:n.ownerDocument)!=null?r:document,a=Array.isArray(n)?t?gd(n):n:Yi(n);s.length>0&&a.length>1&&(a=a.filter(p=>!s.includes(p))),i=i??o.activeElement;let l=(()=>{if(e&5)return 1;if(e&10)return-1;throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last")})(),c=(()=>{if(e&1)return 0;if(e&2)return Math.max(0,a.indexOf(i))-1;if(e&4)return Math.max(0,a.indexOf(i))+1;if(e&8)return a.length-1;throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last")})(),u=e&32?{preventScroll:!0}:{},d=0,h=a.length,f;do{if(d>=h||d+h<=0)return 0;let p=c+d;if(e&16)p=(p+h)%h;else{if(p<0)return 3;if(p>=h)return 1}f=a[p],f==null||f.focus(u),d+=l}while(f!==o.activeElement);return e&6&&md(f)&&f.select(),2}function vd(){return/iPhone/gi.test(window.navigator.platform)||/Mac/gi.test(window.navigator.platform)&&window.navigator.maxTouchPoints>0}function yd(){return/Android/gi.test(window.navigator.userAgent)}function wd(){return vd()||yd()}function ri(n,e,t){Ki.isServer||it(i=>{document.addEventListener(n,e,t),i(()=>document.removeEventListener(n,e,t))})}function Va(n,e,t){Ki.isServer||it(i=>{window.addEventListener(n,e,t),i(()=>window.removeEventListener(n,e,t))})}function Ed(n,e,t=G(()=>!0)){function i(r,o){if(!t.value||r.defaultPrevented)return;let a=o(r);if(a===null||!a.getRootNode().contains(a))return;let l=function c(u){return typeof u=="function"?c(u()):Array.isArray(u)||u instanceof Set?u:[u]}(n);for(let c of l){if(c===null)continue;let u=c instanceof HTMLElement?c:P(c);if(u!=null&&u.contains(a)||r.composed&&r.composedPath().includes(u))return}return!Ba(a,ar.Loose)&&a.tabIndex!==-1&&r.preventDefault(),e(r,a)}let s=w(null);ri("pointerdown",r=>{var o,a;t.value&&(s.value=((a=(o=r.composedPath)==null?void 0:o.call(r))==null?void 0:a[0])||r.target)},!0),ri("mousedown",r=>{var o,a;t.value&&(s.value=((a=(o=r.composedPath)==null?void 0:o.call(r))==null?void 0:a[0])||r.target)},!0),ri("click",r=>{wd()||s.value&&(i(r,()=>s.value),s.value=null)},!0),ri("touchend",r=>i(r,()=>r.target instanceof HTMLElement?r.target:null),!0),Va("blur",r=>i(r,()=>window.document.activeElement instanceof HTMLIFrameElement?window.document.activeElement:null),!0)}function yo(n,e){if(n)return n;let t=e??"button";if(typeof t=="string"&&t.toLowerCase()==="button")return"button"}function Id(n,e){let t=w(yo(n.value.type,n.value.as));return xe(()=>{t.value=yo(n.value.type,n.value.as)}),it(()=>{var i;t.value||P(e)&&P(e)instanceof HTMLButtonElement&&!((i=P(e))!=null&&i.hasAttribute("type"))&&(t.value="button")}),t}var Tn=(n=>(n[n.None=1]="None",n[n.Focusable=2]="Focusable",n[n.Hidden=4]="Hidden",n))(Tn||{});let wi=st({name:"Hidden",props:{as:{type:[Object,String],default:"div"},features:{type:Number,default:1}},setup(n,{slots:e,attrs:t}){return()=>{var i;let{features:s,...r}=n,o={"aria-hidden":(s&2)===2?!0:(i=r["aria-hidden"])!=null?i:void 0,hidden:(s&4)===4?!0:void 0,style:{position:"fixed",top:1,left:1,width:1,height:0,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",borderWidth:"0",...(s&4)===4&&(s&2)!==2&&{display:"none"}}};return qi({ourProps:o,theirProps:r,slot:{},attrs:t,slots:e,name:"Hidden"})}}});function bd({defaultContainers:n=[],portals:e,mainTreeNodeRef:t}={}){let i=w(null),s=Vn(i);function r(){var o,a,l;let c=[];for(let u of n)u!==null&&(u instanceof HTMLElement?c.push(u):"value"in u&&u.value instanceof HTMLElement&&c.push(u.value));if(e!=null&&e.value)for(let u of e.value)c.push(u);for(let u of(o=s==null?void 0:s.querySelectorAll("html > *, body > *"))!=null?o:[])u!==document.body&&u!==document.head&&u instanceof HTMLElement&&u.id!=="headlessui-portal-root"&&(u.contains(P(i))||u.contains((l=(a=P(i))==null?void 0:a.getRootNode())==null?void 0:l.host)||c.some(d=>u.contains(d))||c.push(u));return c}return{resolveContainers:r,contains(o){return r().some(a=>a.contains(o))},mainTreeNodeRef:i,MainTreeNode(){return t!=null?null:Ee(wi,{features:Tn.Hidden,ref:i})}}}var Re=(n=>(n[n.Forwards=0]="Forwards",n[n.Backwards=1]="Backwards",n))(Re||{});function $a(){let n=w(0);return Va("keydown",e=>{e.key==="Tab"&&(n.value=e.shiftKey?1:0)}),n}let ja=Symbol("Context");var kn=(n=>(n[n.Open=1]="Open",n[n.Closed=2]="Closed",n[n.Closing=4]="Closing",n[n.Opening=8]="Opening",n))(kn||{});function Cd(){return zt(ja,null)}function Sd(n){Gi(ja,n)}var Be=(n=>(n.Space=" ",n.Enter="Enter",n.Escape="Escape",n.Backspace="Backspace",n.Delete="Delete",n.ArrowLeft="ArrowLeft",n.ArrowUp="ArrowUp",n.ArrowRight="ArrowRight",n.ArrowDown="ArrowDown",n.Home="Home",n.End="End",n.PageUp="PageUp",n.PageDown="PageDown",n.Tab="Tab",n))(Be||{}),Td=(n=>(n[n.Open=0]="Open",n[n.Closed=1]="Closed",n))(Td||{});let za=Symbol("PopoverContext");function lr(n){let e=zt(za,null);if(e===null){let t=new Error(`<${n} /> is missing a parent <${Ka.name} /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(t,lr),t}return e}let kd=Symbol("PopoverGroupContext");function Ga(){return zt(kd,null)}let qa=Symbol("PopoverPanelContext");function Rd(){return zt(qa,null)}let Ka=st({name:"Popover",inheritAttrs:!1,props:{as:{type:[Object,String],default:"div"}},setup(n,{slots:e,attrs:t,expose:i}){var s;let r=w(null);i({el:r,$el:r});let o=w(1),a=w(null),l=w(null),c=w(null),u=w(null),d=G(()=>Vn(r)),h=G(()=>{var _,I;if(!P(a)||!P(u))return!1;for(let de of document.querySelectorAll("body > *"))if(Number(de==null?void 0:de.contains(P(a)))^Number(de==null?void 0:de.contains(P(u))))return!0;let v=Yi(),M=v.indexOf(P(a)),Y=(M+v.length-1)%v.length,A=(M+1)%v.length,Q=v[Y],ue=v[A];return!((_=P(u))!=null&&_.contains(Q))&&!((I=P(u))!=null&&I.contains(ue))}),f={popoverState:o,buttonId:w(null),panelId:w(null),panel:u,button:a,isPortalled:h,beforePanelSentinel:l,afterPanelSentinel:c,togglePopover(){o.value=Le(o.value,{0:1,1:0})},closePopover(){o.value!==1&&(o.value=1)},close(_){f.closePopover();let I=_?_ instanceof HTMLElement?_:_.value instanceof HTMLElement?P(_):P(f.button):P(f.button);I==null||I.focus()}};Gi(za,f),Sd(G(()=>Le(o.value,{0:kn.Open,1:kn.Closed})));let p={buttonId:f.buttonId,panelId:f.panelId,close(){f.closePopover()}},m=Ga(),C=m==null?void 0:m.registerPopover,[E,S]=cd(),N=bd({mainTreeNodeRef:m==null?void 0:m.mainTreeNodeRef,portals:E,defaultContainers:[a,u]});function T(){var _,I,v,M;return(M=m==null?void 0:m.isFocusWithinPopoverGroup())!=null?M:((_=d.value)==null?void 0:_.activeElement)&&(((I=P(a))==null?void 0:I.contains(d.value.activeElement))||((v=P(u))==null?void 0:v.contains(d.value.activeElement)))}return it(()=>C==null?void 0:C(p)),ud((s=d.value)==null?void 0:s.defaultView,"focus",_=>{var I,v;_.target!==window&&_.target instanceof HTMLElement&&o.value===0&&(T()||a&&u&&(N.contains(_.target)||(I=P(f.beforePanelSentinel))!=null&&I.contains(_.target)||(v=P(f.afterPanelSentinel))!=null&&v.contains(_.target)||f.closePopover()))},!0),Ed(N.resolveContainers,(_,I)=>{var v;f.closePopover(),Ba(I,ar.Loose)||(_.preventDefault(),(v=P(a))==null||v.focus())},G(()=>o.value===0)),()=>{let _={open:o.value===0,close:f.close};return Ee(Bn,[Ee(S,{},()=>qi({theirProps:{...n,...t},ourProps:{ref:r},slot:_,slots:e,attrs:t,name:"Popover"})),Ee(N.MainTreeNode)])}}}),Pd=st({name:"PopoverButton",props:{as:{type:[Object,String],default:"button"},disabled:{type:[Boolean],default:!1},id:{type:String,default:null}},inheritAttrs:!1,setup(n,{attrs:e,slots:t,expose:i}){var s;let r=(s=n.id)!=null?s:`headlessui-popover-button-${yn()}`,o=lr("PopoverButton"),a=G(()=>Vn(o.button));i({el:o.button,$el:o.button}),xe(()=>{o.buttonId.value=r}),or(()=>{o.buttonId.value=null});let l=Ga(),c=l==null?void 0:l.closeOthers,u=Rd(),d=G(()=>u===null?!1:u.value===o.panelId.value),h=w(null),f=`headlessui-focus-sentinel-${yn()}`;d.value||it(()=>{o.button.value=P(h)});let p=Id(G(()=>({as:n.as,type:e.type})),h);function m(_){var I,v,M,Y,A;if(d.value){if(o.popoverState.value===1)return;switch(_.key){case Be.Space:case Be.Enter:_.preventDefault(),(v=(I=_.target).click)==null||v.call(I),o.closePopover(),(M=P(o.button))==null||M.focus();break}}else switch(_.key){case Be.Space:case Be.Enter:_.preventDefault(),_.stopPropagation(),o.popoverState.value===1&&(c==null||c(o.buttonId.value)),o.togglePopover();break;case Be.Escape:if(o.popoverState.value!==0)return c==null?void 0:c(o.buttonId.value);if(!P(o.button)||(Y=a.value)!=null&&Y.activeElement&&!((A=P(o.button))!=null&&A.contains(a.value.activeElement)))return;_.preventDefault(),_.stopPropagation(),o.closePopover();break}}function C(_){d.value||_.key===Be.Space&&_.preventDefault()}function E(_){var I,v;n.disabled||(d.value?(o.closePopover(),(I=P(o.button))==null||I.focus()):(_.preventDefault(),_.stopPropagation(),o.popoverState.value===1&&(c==null||c(o.buttonId.value)),o.togglePopover(),(v=P(o.button))==null||v.focus()))}function S(_){_.preventDefault(),_.stopPropagation()}let N=$a();function T(){let _=P(o.panel);if(!_)return;function I(){Le(N.value,{[Re.Forwards]:()=>ft(_,ke.First),[Re.Backwards]:()=>ft(_,ke.Last)})===yi.Error&&ft(Yi().filter(v=>v.dataset.headlessuiFocusGuard!=="true"),Le(N.value,{[Re.Forwards]:ke.Next,[Re.Backwards]:ke.Previous}),{relativeTo:P(o.button)})}I()}return()=>{let _=o.popoverState.value===0,I={open:_},{...v}=n,M=d.value?{ref:h,type:p.value,onKeydown:m,onClick:E}:{ref:h,id:r,type:p.value,"aria-expanded":o.popoverState.value===0,"aria-controls":P(o.panel)?o.panelId.value:void 0,disabled:n.disabled?!0:void 0,onKeydown:m,onKeyup:C,onClick:E,onMousedown:S};return Ee(Bn,[qi({ourProps:M,theirProps:{...e,...v},slot:I,attrs:e,slots:t,name:"PopoverButton"}),_&&!d.value&&o.isPortalled.value&&Ee(wi,{id:f,features:Tn.Focusable,"data-headlessui-focus-guard":!0,as:"button",type:"button",onFocus:T})])}}}),Nd=st({name:"PopoverPanel",props:{as:{type:[Object,String],default:"div"},static:{type:Boolean,default:!1},unmount:{type:Boolean,default:!0},focus:{type:Boolean,default:!1},id:{type:String,default:null}},inheritAttrs:!1,setup(n,{attrs:e,slots:t,expose:i}){var s;let r=(s=n.id)!=null?s:`headlessui-popover-panel-${yn()}`,{focus:o}=n,a=lr("PopoverPanel"),l=G(()=>Vn(a.panel)),c=`headlessui-focus-sentinel-before-${yn()}`,u=`headlessui-focus-sentinel-after-${yn()}`;i({el:a.panel,$el:a.panel}),xe(()=>{a.panelId.value=r}),or(()=>{a.panelId.value=null}),Gi(qa,a.panelId),it(()=>{var S,N;if(!o||a.popoverState.value!==0||!a.panel)return;let T=(S=l.value)==null?void 0:S.activeElement;(N=P(a.panel))!=null&&N.contains(T)||ft(P(a.panel),ke.First)});let d=Cd(),h=G(()=>d!==null?(d.value&kn.Open)===kn.Open:a.popoverState.value===0);function f(S){var N,T;switch(S.key){case Be.Escape:if(a.popoverState.value!==0||!P(a.panel)||l.value&&!((N=P(a.panel))!=null&&N.contains(l.value.activeElement)))return;S.preventDefault(),S.stopPropagation(),a.closePopover(),(T=P(a.button))==null||T.focus();break}}function p(S){var N,T,_,I,v;let M=S.relatedTarget;M&&P(a.panel)&&((N=P(a.panel))!=null&&N.contains(M)||(a.closePopover(),((_=(T=P(a.beforePanelSentinel))==null?void 0:T.contains)!=null&&_.call(T,M)||(v=(I=P(a.afterPanelSentinel))==null?void 0:I.contains)!=null&&v.call(I,M))&&M.focus({preventScroll:!0})))}let m=$a();function C(){let S=P(a.panel);if(!S)return;function N(){Le(m.value,{[Re.Forwards]:()=>{var T;ft(S,ke.First)===yi.Error&&((T=P(a.afterPanelSentinel))==null||T.focus())},[Re.Backwards]:()=>{var T;(T=P(a.button))==null||T.focus({preventScroll:!0})}})}N()}function E(){let S=P(a.panel);if(!S)return;function N(){Le(m.value,{[Re.Forwards]:()=>{let T=P(a.button),_=P(a.panel);if(!T)return;let I=Yi(),v=I.indexOf(T),M=I.slice(0,v+1),Y=[...I.slice(v+1),...M];for(let A of Y.slice())if(A.dataset.headlessuiFocusGuard==="true"||_!=null&&_.contains(A)){let Q=Y.indexOf(A);Q!==-1&&Y.splice(Q,1)}ft(Y,ke.First,{sorted:!1})},[Re.Backwards]:()=>{var T;ft(S,ke.Previous)===yi.Error&&((T=P(a.button))==null||T.focus())}})}N()}return()=>{let S={open:a.popoverState.value===0,close:a.close},{focus:N,...T}=n,_={ref:a.panel,id:r,onKeydown:f,onFocusout:o&&a.popoverState.value===0?p:void 0,tabIndex:-1};return qi({ourProps:_,theirProps:{...e,...T},attrs:e,slot:S,slots:{...t,default:(...I)=>{var v;return[Ee(Bn,[h.value&&a.isPortalled.value&&Ee(wi,{id:c,ref:a.beforePanelSentinel,features:Tn.Focusable,"data-headlessui-focus-guard":!0,as:"button",type:"button",onFocus:C}),(v=t.default)==null?void 0:v.call(t,...I),h.value&&a.isPortalled.value&&Ee(wi,{id:u,ref:a.afterPanelSentinel,features:Tn.Focusable,"data-headlessui-focus-guard":!0,as:"button",type:"button",onFocus:E})])]}},features:xs.RenderStrategy|xs.Static,visible:h.value,name:"PopoverPanel"})}}});function cr(n){return Fu()?(Uu(n),!0):!1}function Ge(n){return typeof n=="function"?n():b(n)}const ur=typeof window<"u"&&typeof document<"u";typeof WorkerGlobalScope<"u"&&globalThis instanceof WorkerGlobalScope;const Ad=Object.prototype.toString,Od=n=>Ad.call(n)==="[object Object]",Ya=()=>{};function Dd(n,e){function t(...i){return new Promise((s,r)=>{Promise.resolve(n(()=>e.apply(this,i),{fn:e,thisArg:this,args:i})).then(s).catch(r)})}return t}const Qa=n=>n();function xd(n=Qa){const e=w(!0);function t(){e.value=!1}function i(){e.value=!0}const s=(...r)=>{e.value&&n(...r)};return{isActive:Ua(e),pause:t,resume:i,eventFilter:s}}function Ja(n){return rr()}function Md(n,e,t={}){const{eventFilter:i=Qa,...s}=t;return he(n,Dd(i,e),s)}function Ld(n,e,t={}){const{eventFilter:i,...s}=t,{eventFilter:r,pause:o,resume:a,isActive:l}=xd(i);return{stop:Md(n,e,{...s,eventFilter:r}),pause:o,resume:a,isActive:l}}function Xa(n,e=!0,t){Ja()?xe(n,t):e?n():vi(n)}function Fd(n,e){Ja()&&or(n,e)}function Ls(n,e,t={}){const{immediate:i=!0}=t,s=w(!1);let r=null;function o(){r&&(clearTimeout(r),r=null)}function a(){s.value=!1,o()}function l(...c){o(),s.value=!0,r=setTimeout(()=>{s.value=!1,r=null,n(...c)},Ge(e))}return i&&(s.value=!0,ur&&l()),cr(a),{isPending:Ua(s),start:l,stop:a}}function Ei(n){var e;const t=Ge(n);return(e=t==null?void 0:t.$el)!=null?e:t}const Ze=ur?window:void 0,Za=ur?window.document:void 0;function U(...n){let e,t,i,s;if(typeof n[0]=="string"||Array.isArray(n[0])?([t,i,s]=n,e=Ze):[e,t,i,s]=n,!e)return Ya;Array.isArray(t)||(t=[t]),Array.isArray(i)||(i=[i]);const r=[],o=()=>{r.forEach(u=>u()),r.length=0},a=(u,d,h,f)=>(u.addEventListener(d,h,f),()=>u.removeEventListener(d,h,f)),l=he(()=>[Ei(e),Ge(s)],([u,d])=>{if(o(),!u)return;const h=Od(d)?{...d}:d;r.push(...t.flatMap(f=>i.map(p=>a(u,f,p,h))))},{immediate:!0,flush:"post"}),c=()=>{l(),o()};return cr(c),c}function Ud(n){return typeof n=="function"?n:typeof n=="string"?e=>e.key===n:Array.isArray(n)?e=>n.includes(e.key):()=>!0}function wo(...n){let e,t,i={};n.length===3?(e=n[0],t=n[1],i=n[2]):n.length===2?typeof n[1]=="object"?(e=!0,t=n[0],i=n[1]):(e=n[0],t=n[1]):(e=!0,t=n[0]);const{target:s=Ze,eventName:r="keydown",passive:o=!1,dedupe:a=!1}=i,l=Ud(e);return U(s,r,u=>{u.repeat&&Ge(a)||l(u)&&t(u)},o)}function Wd(){const n=w(!1),e=rr();return e&&xe(()=>{n.value=!0},e),n}function el(n){const e=Wd();return G(()=>(e.value,!!n()))}const oi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},ai="__vueuse_ssr_handlers__",Hd=Bd();function Bd(){return ai in oi||(oi[ai]=oi[ai]||{}),oi[ai]}function Vd(n,e){return Hd[n]||e}function $d(n){return n==null?"any":n instanceof Set?"set":n instanceof Map?"map":n instanceof Date?"date":typeof n=="boolean"?"boolean":typeof n=="string"?"string":typeof n=="object"?"object":Number.isNaN(n)?"any":"number"}const jd={boolean:{read:n=>n==="true",write:n=>String(n)},object:{read:n=>JSON.parse(n),write:n=>JSON.stringify(n)},number:{read:n=>Number.parseFloat(n),write:n=>String(n)},any:{read:n=>n,write:n=>String(n)},string:{read:n=>n,write:n=>String(n)},map:{read:n=>new Map(JSON.parse(n)),write:n=>JSON.stringify(Array.from(n.entries()))},set:{read:n=>new Set(JSON.parse(n)),write:n=>JSON.stringify(Array.from(n))},date:{read:n=>new Date(n),write:n=>n.toISOString()}},Eo="vueuse-storage";function zd(n,e,t,i={}){var s;const{flush:r="pre",deep:o=!0,listenToStorageChanges:a=!0,writeDefaults:l=!0,mergeDefaults:c=!1,shallow:u,window:d=Ze,eventFilter:h,onError:f=A=>{console.error(A)},initOnMounted:p}=i,m=(u?Wu:w)(typeof e=="function"?e():e);if(!t)try{t=Vd("getDefaultStorage",()=>{var A;return(A=Ze)==null?void 0:A.localStorage})()}catch(A){f(A)}if(!t)return m;const C=Ge(e),E=$d(C),S=(s=i.serializer)!=null?s:jd[E],{pause:N,resume:T}=Ld(m,()=>I(m.value),{flush:r,deep:o,eventFilter:h});d&&a&&Xa(()=>{U(d,"storage",M),U(d,Eo,Y),p&&M()}),p||M();function _(A,Q){d&&d.dispatchEvent(new CustomEvent(Eo,{detail:{key:n,oldValue:A,newValue:Q,storageArea:t}}))}function I(A){try{const Q=t.getItem(n);if(A==null)_(Q,null),t.removeItem(n);else{const ue=S.write(A);Q!==ue&&(t.setItem(n,ue),_(Q,ue))}}catch(Q){f(Q)}}function v(A){const Q=A?A.newValue:t.getItem(n);if(Q==null)return l&&C!=null&&t.setItem(n,S.write(C)),C;if(!A&&c){const ue=S.read(Q);return typeof c=="function"?c(ue,C):E==="object"&&!Array.isArray(ue)?{...C,...ue}:ue}else return typeof Q!="string"?Q:S.read(Q)}function M(A){if(!(A&&A.storageArea!==t)){if(A&&A.key==null){m.value=C;return}if(!(A&&A.key!==n)){N();try{(A==null?void 0:A.newValue)!==S.write(m.value)&&(m.value=v(A))}catch(Q){f(Q)}finally{A?vi(T):T()}}}}function Y(A){M(A.detail)}return m}const Io=["fullscreenchange","webkitfullscreenchange","webkitendfullscreen","mozfullscreenchange","MSFullscreenChange"];function Gd(n,e={}){const{document:t=Za,autoExit:i=!1}=e,s=G(()=>{var E;return(E=Ei(n))!=null?E:t==null?void 0:t.querySelector("html")}),r=w(!1),o=G(()=>["requestFullscreen","webkitRequestFullscreen","webkitEnterFullscreen","webkitEnterFullScreen","webkitRequestFullScreen","mozRequestFullScreen","msRequestFullscreen"].find(E=>t&&E in t||s.value&&E in s.value)),a=G(()=>["exitFullscreen","webkitExitFullscreen","webkitExitFullScreen","webkitCancelFullScreen","mozCancelFullScreen","msExitFullscreen"].find(E=>t&&E in t||s.value&&E in s.value)),l=G(()=>["fullScreen","webkitIsFullScreen","webkitDisplayingFullscreen","mozFullScreen","msFullscreenElement"].find(E=>t&&E in t||s.value&&E in s.value)),c=["fullscreenElement","webkitFullscreenElement","mozFullScreenElement","msFullscreenElement"].find(E=>t&&E in t),u=el(()=>s.value&&t&&o.value!==void 0&&a.value!==void 0&&l.value!==void 0),d=()=>c?(t==null?void 0:t[c])===s.value:!1,h=()=>{if(l.value){if(t&&t[l.value]!=null)return t[l.value];{const E=s.value;if((E==null?void 0:E[l.value])!=null)return!!E[l.value]}}return!1};async function f(){if(!(!u.value||!r.value)){if(a.value)if((t==null?void 0:t[a.value])!=null)await t[a.value]();else{const E=s.value;(E==null?void 0:E[a.value])!=null&&await E[a.value]()}r.value=!1}}async function p(){if(!u.value||r.value)return;h()&&await f();const E=s.value;o.value&&(E==null?void 0:E[o.value])!=null&&(await E[o.value](),r.value=!0)}async function m(){await(r.value?f():p())}const C=()=>{const E=h();(!E||E&&d())&&(r.value=E)};return U(t,Io,C,!1),U(()=>Ei(s),Io,C,!1),i&&cr(f),{isSupported:u,isFullscreen:r,enter:p,exit:f,toggle:m}}function li(n,e,t={}){const{window:i=Ze}=t;return zd(n,e,i==null?void 0:i.localStorage,t)}const qd={page:n=>[n.pageX,n.pageY],client:n=>[n.clientX,n.clientY],screen:n=>[n.screenX,n.screenY],movement:n=>n instanceof Touch?null:[n.movementX,n.movementY]};function Kd(n={}){const{type:e="page",touch:t=!0,resetOnTouchEnds:i=!1,initialValue:s={x:0,y:0},window:r=Ze,target:o=r,scroll:a=!0,eventFilter:l}=n;let c=null;const u=w(s.x),d=w(s.y),h=w(null),f=typeof e=="function"?e:qd[e],p=_=>{const I=f(_);c=_,I&&([u.value,d.value]=I,h.value="mouse")},m=_=>{if(_.touches.length>0){const I=f(_.touches[0]);I&&([u.value,d.value]=I,h.value="touch")}},C=()=>{if(!c||!r)return;const _=f(c);c instanceof MouseEvent&&_&&(u.value=_[0]+r.scrollX,d.value=_[1]+r.scrollY)},E=()=>{u.value=s.x,d.value=s.y},S=l?_=>l(()=>p(_),{}):_=>p(_),N=l?_=>l(()=>m(_),{}):_=>m(_),T=l?()=>l(()=>C(),{}):()=>C();if(o){const _={passive:!0};U(o,["mousemove","dragover"],S,_),t&&e!=="movement"&&(U(o,["touchstart","touchmove"],N,_),i&&U(o,"touchend",E,_)),a&&e==="page"&&U(r,"scroll",T,{passive:!0})}return{x:u,y:d,sourceType:h}}function Yd(n,e={}){const{handleOutside:t=!0,window:i=Ze}=e,s=e.type||"page",{x:r,y:o,sourceType:a}=Kd(e),l=w(n??(i==null?void 0:i.document.body)),c=w(0),u=w(0),d=w(0),h=w(0),f=w(0),p=w(0),m=w(!0);let C=()=>{};return i&&(C=he([l,r,o],()=>{const E=Ei(l);if(!E)return;const{left:S,top:N,width:T,height:_}=E.getBoundingClientRect();d.value=S+(s==="page"?i.pageXOffset:0),h.value=N+(s==="page"?i.pageYOffset:0),f.value=_,p.value=T;const I=r.value-d.value,v=o.value-h.value;m.value=T===0||_===0||I<0||v<0||I>T||v>_,(t||!m.value)&&(c.value=I,u.value=v)},{immediate:!0}),U(document,"mouseleave",()=>{m.value=!0})),{x:r,y:o,sourceType:a,elementX:c,elementY:u,elementPositionX:d,elementPositionY:h,elementHeight:f,elementWidth:p,isOutside:m,stop:C}}function Qd(n={}){const{window:e=Ze}=n,t=el(()=>e&&"screen"in e&&"orientation"in e.screen),i=t.value?e.screen.orientation:{},s=w(i.type),r=w(i.angle||0);return t.value&&U(e,"orientationchange",()=>{s.value=i.type,r.value=i.angle}),{isSupported:t,orientation:s,angle:r,lockOrientation:l=>t.value&&typeof i.lock=="function"?i.lock(l):Promise.reject(new Error("Not supported")),unlockOrientation:()=>{t.value&&typeof i.unlock=="function"&&i.unlock()}}}function Jd(n,e=Ya,t={}){const{immediate:i=!0,manual:s=!1,type:r="text/javascript",async:o=!0,crossOrigin:a,referrerPolicy:l,noModule:c,defer:u,document:d=Za,attrs:h={}}=t,f=w(null);let p=null;const m=S=>new Promise((N,T)=>{const _=M=>(f.value=M,N(M),M);if(!d){N(!1);return}let I=!1,v=d.querySelector(`script[src="${Ge(n)}"]`);v?v.hasAttribute("data-loaded")&&_(v):(v=d.createElement("script"),v.type=r,v.async=o,v.src=Ge(n),u&&(v.defer=u),a&&(v.crossOrigin=a),c&&(v.noModule=c),l&&(v.referrerPolicy=l),Object.entries(h).forEach(([M,Y])=>v==null?void 0:v.setAttribute(M,Y)),I=!0),v.addEventListener("error",M=>T(M)),v.addEventListener("abort",M=>T(M)),v.addEventListener("load",()=>{v.setAttribute("data-loaded","true"),e(v),_(v)}),I&&(v=d.head.appendChild(v)),S||_(v)}),C=(S=!0)=>(p||(p=m(S)),p),E=()=>{if(!d)return;p=null,f.value&&(f.value=null);const S=d.querySelector(`script[src="${Ge(n)}"]`);S&&d.head.removeChild(S)};return i&&!s&&Xa(C),s||Fd(E),{scriptTag:f,load:C,unload:E}}const Xd=()=>Hu().$device,Zd=["controls","poster"],eh=L("p",{class:"vjs-no-js"},[Pt(" To view this video please enable JavaScript, and consider upgrading to a web browser that "),L("a",{href:"https://videojs.com/html5-video-support/",target:"_blank"},"supports HTML5 video")],-1),th=[eh],nh={key:0},ih={key:2,id:"loading-spinner",class:"absolute inset-0 z-0 flex items-center justify-center bg-black/30 text-black"},sh={class:"flex w-full bg-zinc-800/80 px-1 duration-200 dark:bg-black/75 md:px-2 items-center"},rh={key:0,class:"group/volume flex items-center gap-1"},oh={class:"relative flex h-full w-16 items-center duration-200 group-hover/volume:w-20 md:w-20"},ah={class:"absolute inset-0 top-1/2 h-1 z-0 w-16 overflow-hidden rounded-sm bg-gray-300/25 md:w-20"},lh=L("div",{class:"flex-1"},null,-1),ch=L("div",{class:"border-b border-white/20 px-3 py-1.5 md:px-4 md:py-2.5"}," Kualitas ",-1),uh={class:"flex w-[220px] flex-col py-1 text-base md:w-[250px]"},dh={class:"h-10 w-10"},hh=st({__name:"VideoPlayer",props:{sources:{},poster:{},landscape:{type:Boolean,default:!0},useShortcut:{type:Boolean,default:!0},useDefaultControl:{type:Boolean,default:!1},hideControl:{type:Boolean,default:!1},saveState:{type:Boolean,default:!0},rotateFill:{default:"width"},videoFill:{default:"width"},compact:{type:Boolean,default:!1},title:{}},setup(n,{expose:e}){const t=n,i=w(t.sources.filter(y=>y.type==="hls")??[]);he(()=>t.sources,()=>{i.value=t.sources.filter(y=>y.type==="hls")??[]});const s=li("quality-id",2),r=w((i.value??[]).find(y=>s.value===y.id)??i.value[0]),o=w(),a=w(),l=w(),c=t.saveState?li("data-volume",0):w(1),u=w(!1),d=t.saveState?li("data-muted",!1):w(!1),h=w(!1),f=w(!0),p=w(0),{isMobile:m}=Xd(),{start:C,stop:E}=Ls(()=>{Tt()},1e4),S=w(!1);function N(y,z=!1){const W=Number.parseFloat(y);a.value&&(W===0?(a.value.muted=!0,a.value.volume=0):(a.value.muted=!1,a.value.volume=W),W>0&&(c.value=W),z||(d.value=a.value.muted),u.value=a.value.muted)}const T=w(!1),_=w(!1),I=w(!1),{start:v,stop:M}=Ls(()=>{I.value=!1,_.value=!1,de(!1)},2500);he(_,y=>{y&&v()});const{isOutside:Y,x:A,y:Q}=Yd(o);he(A,()=>{!m&&!Y.value!==T.value&&de(!Y.value),v()}),he(Q,()=>{!m&&!Y.value!==T.value&&de(!Y.value),v()}),he(_,y=>{m||de(y)});const ue=w(null);U(ue,"input",y=>{de(!0),N(y.target.value)});function de(y){y?v():(console.log("Awww"),_.value=!1,I.value=!1,M()),T.value=y}const lu=w(0),so=w(!1);Jd("https://cdn.jsdelivr.net/npm/hls.js@1.5.6",()=>{nn(r.value.url)},{defer:!0});const tn=w(!1),ro=w(!0);xe(()=>{!so.value&&typeof Hls<"u"&&(so.value=!0,nn(r.value.url))});function nn(y){var z;Hls.isSupported()&&!tn.value?(lu.value=0,f.value=!0,Xn(),l.value=new Hls({enableWorker:!1,liveDurationInfinity:!0,maxBufferSize:254*1e3*1e3,maxBufferLength:60,lowLatencyMode:!0}),l.value.on(Hls.Events.ERROR,(W,pe)=>{if(console.error(pe),pe.details==="manifestParsingError"&&!tn.value)return tn.value=!0,nn(y);if(C(),pe.fatal)switch(pe.type){case Hls.ErrorTypes.NETWORK_ERROR:console.error("fatal network error encountered, try to recover"),l.value.startLoad();break;case Hls.ErrorTypes.MEDIA_ERROR:console.error("fatal media error encountered, try to recover"),l.value.recoverMediaError();break;default:if(console.error("cannot recover error"),ro.value)return ro.value=!1,nn(y);Tt();break}else pe.details===Hls.ErrorDetails.BUFFER_STALLED_ERROR&&(f.value=!0)}),l.value.on(Hls.Events.FRAG_BUFFERED,()=>{E(),f.value=!1}),l.value.on(Hls.Events.MANIFEST_LOADING,()=>{f.value=!0}),l.value.on(Hls.Events.LEVEL_LOADED,()=>{E(),f.value=!1}),l.value.attachMedia(a.value),l.value.loadSource(y),kt()):a.value&&((z=a.value)==null||z.setAttribute("src",y),kt())}function Xn(){l.value&&l.value.destroy()}function cu(){a.value&&(a.value.muted?ei():Zn())}function Zn(){a.value?(a.value.muted=!0,u.value=!0):N(0)}function ei(){a.value?(a.value.muted=!1,u.value=!1):N(c.value||1)}const ti=w(!1);async function sn(){if(!ti.value&&a.value){ti.value=!0;try{a.value.paused?(S.value=!1,await kt()):(S.value=!0,await a.value.pause()),ti.value=!1}catch{ti.value=!1}}}function Tt(){h.value=!1,f.value=!0,tn.value=!1,E();try{nn(r.value.url)}catch(y){console.error(y),Xn()}}const rn=w();U(rn,"pointerenter",()=>{I.value=!0}),U(rn,"pointerleave",()=>{I.value=!1}),U(rn,"focusin",()=>{m||(_.value=!0)}),U(a,"click",()=>{m||(_.value=!0)}),U(rn,"focusout",()=>{_.value=!1});const{isSupported:oo,orientation:uu,lockOrientation:ao,unlockOrientation:du}=Qd(),fs=w(0),ps=w(0),on=G(()=>ps.value<=fs.value),lo=w(!1),{isFullscreen:hu,toggle:co}=Gd(o),an=G(()=>lo.value||hu.value);async function fu(){if(an.value)du(),await co();else{const y=uu.value;await co();try{on.value?["portrait-primary","portrait-secondary","portrait"].includes(y??"")&&oo.value&&await ao("landscape"):["landscape-primary","landscape-secondary","landscape"].includes(y??"")&&oo.value&&await ao("portrait")}catch(z){console.error(z)}}}function pu(){var y;document.pictureInPictureElement?document.exitPictureInPicture():document.pictureInPictureEnabled&&((y=a.value)==null||y.requestPictureInPicture())}function uo(y){tn.value=!1,s.value=y.id,r.value=y,Tt()}const ni=w(0);he(h,y=>{!y&&!S.value?C():(E(),ni.value=0)},{immediate:!0});async function kt(){if(S.value=!1,a.value)try{d.value?Zn():ei(),await a.value.play()}catch{if(ni.value>5)return;ni.value+=1,await vi(async()=>(ni.value>4&&(a.value&&(a.value.muted=!0,a.value.volume=0),p.value=0,u.value=!0),kt()))}}const _u=w(!1),ho=w(!1);he(an,()=>{ho.value=window.innerHeight<=window.innerWidth,si()});const ln=w(0),ii=w(0);Fa(()=>{Xn(),document!=null&&document.pictureInPictureElement&&document.exitPictureInPicture()});function mu(){m?T.value?de(!1):de(!0):sn()}function gu(){Xn(),document!=null&&document.pictureInPictureElement&&document.exitPictureInPicture()}const _s=w(),vu=G(()=>ln.value===0?0:ii.value/ln.value*100);t.useShortcut&&(wo("ArrowLeft",()=>{const y=ii.value-2;a.value&&(a.value.currentTime=y<0?0:y)},{eventName:"keyup"}),wo("ArrowRight",()=>{const y=ii.value+2,z=ln.value-3;a.value&&(a.value.currentTime=y>z?z:y)},{eventName:"keyup"})),he(vu,y=>{_s.value&&(_s.value.value=String(y*(Number(_s.value.max)||0)/100))},{immediate:!0});function yu(){var y;return(y=a.value)==null?void 0:y.getAttribute("prop")}U(a,"volumechange",y=>{var z,W;u.value=(z=y.target)==null?void 0:z.muted,p.value=((W=y.target)==null?void 0:W.volume)||0});const wu=G(()=>!u.value&&p.value>=.5?"material-symbols:volume-up":!u.value&&p.value>0?"material-symbols:volume-down":"material-symbols:volume-off"),Eu=G(()=>h.value?"material-symbols:pause":"material-symbols:play-arrow");function Iu(){var y;(y=a.value)==null||y.pause(),S.value=!0}function bu(){a.value&&(a.value.currentTime=ln.value-3)}const cn=li("rotate_feature_v1",()=>!1),un=w(0);function Cu(){cn.value&&(un.value+=90)}const at=w(null),fo=G(()=>un.value/90%2!==0);function si(){var z;if(!at.value){const W=(z=a.value)==null?void 0:z.getBoundingClientRect();at.value={width:(W==null?void 0:W.width)||0,height:(W==null?void 0:W.height)||0}}const y=un.value;if(!(!a.value||!o.value)&&(a.value.style.removeProperty("scale"),y/90%2!==0)){if(!at.value)return;const W=at.value.height/at.value.width,pe=at.value.width/at.value.height;let lt;t.rotateFill==="width"?lt=pe:lt=W,an.value&&(lt=ho.value?on.value?W:pe:on.value?pe:W),a.value.style.scale=`${lt}`}}he(un,()=>{requestAnimationFrame(()=>si())}),U(a,"loadedmetadata",function(){fs.value=this.videoWidth,ps.value=this.videoHeight}),U(a,"loadeddata",function(){fs.value=this.videoWidth,ps.value=this.videoHeight}),U(a,"play",()=>{f.value=!1,h.value=!0}),U(a,"pause",()=>{f.value=!1,h.value=!1}),U(a,"playing",()=>{f.value=!1,h.value=!0}),U(a,"stalled",()=>{f.value=!0}),U(a,"durationchange",()=>{var y;ln.value=((y=a.value)==null?void 0:y.duration)||0}),U(a,"timeupdate",()=>{var y;_u.value||(ii.value=((y=a.value)==null?void 0:y.currentTime)||0)}),U(a,"loadstart",()=>{f.value=!0});function ms(){lo.value=document.fullscreenElement!==null}U(a,"webkitfullscreenchange",()=>{ms()}),U(a,"mozfullscreenchange",()=>{ms()}),U(a,"fullscreenchange",()=>{ms()});const po=w(!1);xe(()=>{U(window,"resize",()=>{requestAnimationFrame(()=>si())}),po.value=document.pictureInPictureEnabled;try{navigator.mediaSession.setActionHandler("nexttrack",()=>{Tt()})}catch(y){console.error(y)}a.value&&(p.value=Number(c.value)||1,N(p.value),h.value=!a.value.paused),vi(()=>{d.value?Zn():ei()})});const Su=G(()=>{const y=fo.value?"aspect-[9/12]":"aspect-video",z=fo.value?"aspect-video":"aspect-[9/12]";return on.value?y:z}),_o=w(!1);return xe(()=>{_o.value=!0}),e({stop:gu,rotate:Cu,syncLive:bu,calculateVideoSize:si,isPlaying:h,isMuted:u,reload:Tt,togglePlay:sn,isLandscape:on,changeSource:uo,checkMute:yu,volume:p,pause:Iu,play:kt,mute:Zn,unmute:ei,setVolume:N}),(y,z)=>{const W=Ru,pe=nd,lt=Pd,Tu=Nd,ku=Ka;return V(),X("div",{ref_key:"videoPlayer",ref:o,class:dn(["overflow-hidden relative group flex items-center transform-all duration-300",[b(cn)?y.rotateFill==="width"?b(Su):"h-full w-full":"w-full h-full",{"!cursor-none":!b(T)&&b(h),invisible:!b(_o)}]])},[L("video",{ref_key:"video",ref:a,playsinline:"",controls:!(!y.useDefaultControl||b(cn)||y.hideControl),class:dn([{"object-cover":!b(an)},"inset-0 w-full h-full transition-all duration-500 origin-center"]),style:mo({transform:b(cn)?`rotate(${b(un)}deg)`:"none"}),poster:y.poster,onClick:mu},th,14,Zd),!y.useDefaultControl||b(cn)?(V(),X("div",nh,[!b(h)&&!b(f)?(V(),X("div",{key:0,class:"z-10 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-black/50 p-1",onClick:z[0]||(z[0]=()=>{b(m)&&sn()})},[_e(W,{name:"material-symbols:play-arrow",class:"text-white/60",size:"3rem"})])):te("",!0),b(m)&&b(h)&&b(T)&&!b(f)?(V(),X("div",{key:1,class:"z-10 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-black/50 p-1",onClick:sn},[_e(W,{name:"material-symbols:pause",class:"text-white/60",size:"3rem"})])):te("",!0),b(f)?(V(),X("div",ih,[_e(pe,{class:"text-white size-12"})])):te("",!0),y.title?(V(),X("div",{key:3,class:dn([{"opacity-100":b(T)||b(_)||b(I)},"absolute top-0 inset-x-0 z-10 opacity-0 text-white px-3 pt-2 pb-4 text-base md:text-lg font-bold bg-title transition-opacity duration-200"])},we(y.title),3)):te("",!0),L("div",{id:"control",ref_key:"videoControl",ref:rn,class:dn([{"opacity-100":b(T)||b(_)||b(I)},"absolute inset-x-0 bottom-0 z-10 text-slate-200 opacity-0 duration-200 ease-in-out transition-opacity"]),onClick:z[2]||(z[2]=ct=>de(!0))},[L("div",{class:dn({"pointer-events-none":b(m)&&!b(T)})},[L("div",sh,[L("button",{class:"h-7 w-7 md:h-8 md:w-8 p-0.5 md:p-1","aria-label":"Play",type:"button",onClick:sn},[_e(W,{name:b(Eu),class:"h-full w-full"},null,8,["name"])]),y.compact?te("",!0):(V(),X("div",rh,[L("button",{class:"h-7 w-7 md:h-8 md:w-8 p-0.5 md:p-1","aria-label":"Mute",type:"button",onClick:cu},[_e(W,{name:b(wu),class:"h-full w-full"},null,8,["name"])]),L("div",oh,[L("div",ah,[L("div",{class:"h-full bg-slate-200",style:mo({width:`${b(p)*100}%`})},null,4)]),Bu(L("input",{ref_key:"volumeSlider",ref:ue,"onUpdate:modelValue":z[1]||(z[1]=ct=>$u(p)?p.value=ct:null),"aria-label":"Volume",type:"range",min:"0",max:"1",step:"0.01",class:"volume-slider z-20 h-1 w-16 cursor-pointer md:w-20 pt-1"},null,512),[[Vu,b(p)]])])])),lh,L("button",{class:"h-7 w-7 md:h-8 md:w-8 p-0.5 md:p-1","aria-label":"Reload",type:"button",onClick:Tt},[_e(W,{name:"material-symbols:refresh",class:"h-full w-full p-[1px]"})]),y.compact?te("",!0):(V(),ht(ku,{key:1},{default:hn(()=>[_e(lt,{"aria-label":"Setting",class:"h-7 w-7 md:h-8 md:w-8 p-0.5 md:p-1"},{default:hn(()=>[_e(W,{name:"material-symbols:settings",class:"h-full w-full p-[2px] duration-300"})]),_:1}),_e(zu,{"enter-active-class":"transition duration-200 ease-out","enter-from-class":"translate-y-2 translate-x-1 opacity-0","enter-to-class":"translate-y-0 translate-x-0 opacity-100","leave-active-class":"transition duration-150 ease-in","leave-from-class":"translate-y-0 translate-x-x opacity-100","leave-to-class":"translate-y-2 translate-x-1 opacity-0"},{default:hn(()=>[_e(Tu,{class:"absolute bottom-11 right-4 rounded-md bg-black/70 dark:bg-black/80"},{default:hn(()=>[L("div",null,[ch,L("div",uh,[(V(!0),X(Bn,null,ju(b(i),ct=>(V(),ht(lt,{key:ct.id,class:"flex items-center truncate text-left text-sm hover:bg-black/50",onClick:()=>uo(ct)},{default:hn(()=>[L("div",dh,[b(r).id===ct.id?(V(),ht(W,{key:0,name:"ic:round-check",class:"h-full w-full p-2.5"})):te("",!0)]),L("div",null,we(ct.label),1)]),_:2},1032,["onClick"]))),128))])])]),_:1})]),_:1})]),_:1})),b(po)?(V(),X("button",{key:2,class:"group h-7 w-7 md:h-8 md:w-8 p-0.5 md:p-1","aria-label":"Fullscreen",type:"button",onClick:pu},[_e(W,{name:"material-symbols:picture-in-picture-sharp",class:"h-full w-full p-0.5 duration-300"})])):te("",!0),L("button",{class:"group h-7 w-7 md:h-8 md:w-8 p-0.5 md:p-1","aria-label":"Fullscreen",type:"button",onClick:fu},[b(an)?(V(),ht(W,{key:1,name:"material-symbols:fullscreen-exit",class:"h-full w-full duration-300 hover:scale-125"})):(V(),ht(W,{key:0,name:"material-symbols:fullscreen",class:"h-full w-full duration-300 hover:scale-125"}))])])],2)],2)])):te("",!0)],2)}}});function fh(){return Gu}class ph{static encrypt(e,t){let i="";for(let s=0;s<e.length;s++){const r=s%t.length,a=`00${(e[s].charCodeAt(0)^t[r].charCodeAt(0)).toString(16)}`.slice(-2);i+=a}return i}static decrypt(e,t){let i="";const s=[];let r;for(r=0;r<e.length;r=r+2)s.push(e[r]+e[r+1]);for(r=0;r<s.length;r++){const o=s[r],a=parseInt(o,16),l=r%t.length,c=a^t[l].charCodeAt(0);i+=String.fromCharCode(c)}return i}}const _h="KimiNo";function mh(n){return ph.decrypt(n,_h+gh+yh)}const gh="Kotoga";function vh(n){return typeof n=="string"&&(n=parseInt(n)),n.toString().length>10}const yh="SukiDakara",wh={key:0,class:"text-center flex flex-col gap-1"},Eh={class:"text-xl"},Ih={class:"flex gap-3 justify-center"},bh={key:0,class:"flex flex-col justify-center items-center bg-white text-zinc-800 size-12 rounded-md"},Ch={class:"leading-6"},Sh=L("span",{class:"text-sm"},"bulan",-1),Th={key:1,class:"flex flex-col justify-center items-center bg-white text-zinc-800 size-12 rounded-md"},kh={class:"leading-6"},Rh=L("span",{class:"text-sm"},"hari",-1),Ph={key:2,class:"flex flex-col justify-center items-center bg-white text-zinc-800 size-12 rounded-md"},Nh={class:"leading-6"},Ah=L("span",{class:"text-sm"},"jam",-1),Oh={key:3,class:"flex flex-col justify-center items-center bg-white text-zinc-800 size-12 rounded-md"},Dh={class:"leading-6"},xh=L("span",{class:"text-sm"},"menit",-1),Mh={key:4,class:"flex flex-col justify-center items-center bg-white text-zinc-800 size-12 rounded-md"},Lh={class:"leading-6"},Fh=L("span",{class:"text-sm"},"detik",-1),Uh=st({__name:"CountDown",props:{time:{}},setup(n){const e=n,t=fh(),i=t(vh(e.time)?e.time:Number(e.time)*1e3),s=w(t.duration(i.diff(t()))),r=w(s.value.asSeconds()<=0),{start:o}=Ls(()=>{const a=s.value.subtract(1,"seconds");s.value.asSeconds()<=1?(r.value=!0,s.value=t.duration(0)):(s.value=a,o())},1e3,{immediate:!0});return(a,l)=>(V(),X("div",null,[b(r)?te("",!0):(V(),X("div",wh,[L("div",Eh,we(b(i).format("dddd, DD MMMM YYYY")),1),L("div",Ih,[b(s).months()>0?(V(),X("div",bh,[L("span",Ch,we(b(s).months()),1),Pt(),Sh])):te("",!0),b(s).days()>0?(V(),X("div",Th,[L("span",kh,we(b(s).days()),1),Pt(),Rh])):te("",!0),b(s).hours()>0?(V(),X("div",Ph,[L("span",Nh,we(b(s).hours()),1),Pt(),Ah])):te("",!0),b(s).minutes()>0?(V(),X("div",Oh,[L("span",Dh,we(b(s).minutes()),1),Pt(),xh])):te("",!0),b(s).seconds()>0||b(s).asSeconds()>0?(V(),X("div",Mh,[L("span",Lh,we(b(s).seconds()),1),Pt(),Fh])):te("",!0)])]))]))}});var bo={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _n;class k{constructor(e,t,i){this.children_=e,this.priorityNode_=t,this.indexMap_=i,this.lazyHash_=null,this.priorityNode_&&jl(this.priorityNode_),this.children_.isEmpty()&&g(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}static get EMPTY_NODE(){return _n||(_n=new k(new le(Cr),null,Ne.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||_n}updatePriority(e){return this.children_.isEmpty()?this:new k(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?_n:t}}getChild(e){const t=O(e);return t===null?this:this.getImmediateChild(t).getChild($(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(g(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const i=new x(e,t);let s,r;t.isEmpty()?(s=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(i,this.children_)):(s=this.children_.insert(e,t),r=this.indexMap_.addToIndexes(i,this.children_));const o=s.isEmpty()?_n:this.priorityNode_;return new k(s,o,r)}}updateChild(e,t){const i=O(e);if(i===null)return t;{g(O(e)!==".priority"||et(e)===1,".priority must be the last token in a path");const s=this.getImmediateChild(i).updateChild($(e),t);return this.updateImmediateChild(i,s)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let i=0,s=0,r=!0;if(this.forEachChild(K,(o,a)=>{t[o]=a.val(e),i++,r&&k.INTEGER_REGEXP_.test(o)?s=Math.max(s,Number(o)):r=!1}),!e&&r&&s<2*i){const o=[];for(const a in t)o[a]=t[a];return o}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+$l(this.getPriority().val())+":"),this.forEachChild(K,(t,i)=>{const s=i.hash();s!==""&&(e+=":"+t+":"+s)}),this.lazyHash_=e===""?"":yl(e)}return this.lazyHash_}getPredecessorChildName(e,t,i){const s=this.resolveIndex_(i);if(s){const r=s.getPredecessorKey(new x(e,t));return r?r.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const i=t.minKey();return i&&i.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new x(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const i=t.maxKey();return i&&i.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new x(t,this.children_.get(t)):null}forEachChild(e,t){const i=this.resolveIndex_(e);return i?i.inorderTraversal(s=>t(s.name,s.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const i=this.resolveIndex_(t);if(i)return i.getIteratorFrom(e,s=>s);{const s=this.children_.getIteratorFrom(e.name,x.Wrap);let r=s.peek();for(;r!=null&&t.compare(r,e)<0;)s.getNext(),r=s.peek();return s}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const i=this.resolveIndex_(t);if(i)return i.getReverseIteratorFrom(e,s=>s);{const s=this.children_.getReverseIteratorFrom(e.name,x.Wrap);let r=s.peek();for(;r!=null&&t.compare(r,e)>0;)s.getNext(),r=s.peek();return s}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===Gn?-1:0}withIndex(e){if(e===Dt||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new k(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===Dt||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const i=this.getIterator(K),s=t.getIterator(K);let r=i.getNext(),o=s.getNext();for(;r&&o;){if(r.name!==o.name||!r.node.equals(o.node))return!1;r=i.getNext(),o=s.getNext()}return r===null&&o===null}else return!1;else return!1}}resolveIndex_(e){return e===Dt?null:this.indexMap_.get(e.toString())}}k.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class b_ extends k{constructor(){super(new le(Cr),k.EMPTY_NODE,Ne.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return k.EMPTY_NODE}isEmpty(){return!1}}const Gn=new b_;Object.defineProperties(x,{MIN:{value:new x(Ht,k.EMPTY_NODE)},MAX:{value:new x(vt,Gn)}});Vl.__EMPTY_NODE=k.EMPTY_NODE;ee.__childrenNodeConstructor=k;g_(Gn);y_(Gn);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S_ extends Xi{constructor(e){super(),this.indexPath_=e,g(!D(e)&&O(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const i=this.extractChild(e.node),s=this.extractChild(t.node),r=i.compareTo(s);return r===0?bt(e.name,t.name):r}makePost(e,t){const i=J(e),s=k.EMPTY_NODE.updateChild(this.indexPath_,i);return new x(t,s)}maxPost(){const e=k.EMPTY_NODE.updateChild(this.indexPath_,Gn);return new x(vt,e)}toString(){return An(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T_ extends Xi{compare(e,t){const i=e.node.compareTo(t.node);return i===0?bt(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return x.MIN}maxPost(){return x.MAX}makePost(e,t){const i=J(e);return new x(t,i)}toString(){return".value"}}const k_=new T_;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Di{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=ge.ACK_USER_WRITE,this.source=kr()}operationForChild(e){if(D(this.path)){if(this.affectedTree.value!=null)return g(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new H(e));return new Di(F(),t,this.revert)}}else return g(O(this.path)===e,"operationForChild called for unrelated child."),new Di($(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mn{constructor(e,t){this.source=e,this.path=t,this.type=ge.LISTEN_COMPLETE}operationForChild(e){return D(this.path)?new Mn(this.source,F()):new Mn(this.source,$(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yt{constructor(e,t,i){this.source=e,this.path=t,this.snap=i,this.type=ge.OVERWRITE}operationForChild(e){return D(this.path)?new yt(this.source,F(),this.snap.getImmediateChild(e)):new yt(this.source,$(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vt{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=ge.MERGE}operationForChild(e){if(D(this.path)){const t=this.children.subtree(new H(e));return t.isEmpty()?null:t.value?new yt(this.source,F(),t.value):new Vt(this.source,F(),t)}else return g(O(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Vt(this.source,$(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sm(n){return{filter:n}}function rm(n,e){g(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),g(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function om(n,e,t,i,s){const r=new nm;let o,a;if(t.type===ge.OVERWRITE){const c=t;c.source.fromUser?o=Qs(n,e,c.path,c.snap,i,s,r):(g(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!D(c.path),o=Fi(n,e,c.path,c.snap,i,s,a,r))}else if(t.type===ge.MERGE){const c=t;c.source.fromUser?o=lm(n,e,c.path,c.children,i,s,r):(g(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=Js(n,e,c.path,c.children,i,s,a,r))}else if(t.type===ge.ACK_USER_WRITE){const c=t;c.revert?o=dm(n,e,c.path,i,s,r):o=cm(n,e,c.path,c.affectedTree,i,s,r)}else if(t.type===ge.LISTEN_COMPLETE)o=um(n,e,t.path,i,r);else throw Gt("Unknown operation type: "+t.type);const l=r.getChanges();return am(e,o,l),{viewCache:o,changes:l}}function am(n,e,t){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=xi(n);(t.length>0||!n.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&t.push(ql(xi(e)))}}function tc(n,e,t,i,s,r){const o=e.eventCache;if(Li(i,t)!=null)return e;{let a,l;if(D(t))if(g(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=wt(e),u=c instanceof k?c:k.EMPTY_NODE,d=Nr(i,u);a=n.filter.updateFullNode(e.eventCache.getNode(),d,r)}else{const c=Mi(i,wt(e));a=n.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=O(t);if(c===".priority"){g(et(t)===1,"Can't have a priority with additional path components");const u=o.getNode();l=e.serverCache.getNode();const d=ta(i,t,u,l);d!=null?a=n.filter.updatePriority(u,d):a=o.getNode()}else{const u=$(t);let d;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const h=ta(i,t,o.getNode(),l);h!=null?d=o.getNode().getImmediateChild(c).updateChild(u,h):d=o.getNode().getImmediateChild(c)}else d=Ar(i,c,e.serverCache);d!=null?a=n.filter.updateChild(o.getNode(),c,d,u,s,r):a=o.getNode()}}return In(e,a,o.isFullyInitialized()||D(t),n.filter.filtersNodes())}}function Fi(n,e,t,i,s,r,o,a){const l=e.serverCache;let c;const u=o?n.filter:n.filter.getIndexedFilter();if(D(t))c=u.updateFullNode(l.getNode(),i,null);else if(u.filtersNodes()&&!l.isFiltered()){const f=l.getNode().updateChild(t,i);c=u.updateFullNode(l.getNode(),f,null)}else{const f=O(t);if(!l.isCompleteForPath(t)&&et(t)>1)return e;const p=$(t),C=l.getNode().getImmediateChild(f).updateChild(p,i);f===".priority"?c=u.updatePriority(l.getNode(),C):c=u.updateChild(l.getNode(),f,C,p,ec,null)}const d=Kl(e,c,l.isFullyInitialized()||D(t),u.filtersNodes()),h=new Or(s,d,r);return tc(n,d,t,s,h,a)}function Qs(n,e,t,i,s,r,o){const a=e.eventCache;let l,c;const u=new Or(s,e,r);if(D(t))c=n.filter.updateFullNode(e.eventCache.getNode(),i,o),l=In(e,c,!0,n.filter.filtersNodes());else{const d=O(t);if(d===".priority")c=n.filter.updatePriority(e.eventCache.getNode(),i),l=In(e,c,a.isFullyInitialized(),a.isFiltered());else{const h=$(t),f=a.getNode().getImmediateChild(d);let p;if(D(h))p=i;else{const m=u.getCompleteChild(d);m!=null?Er(h)===".priority"&&m.getChild(Hl(h)).isEmpty()?p=m:p=m.updateChild(h,i):p=k.EMPTY_NODE}if(f.equals(p))l=e;else{const m=n.filter.updateChild(a.getNode(),d,p,h,u,o);l=In(e,m,a.isFullyInitialized(),n.filter.filtersNodes())}}}return l}function na(n,e){return n.eventCache.isCompleteForChild(e)}function lm(n,e,t,i,s,r,o){let a=e;return i.foreach((l,c)=>{const u=q(t,l);na(e,O(u))&&(a=Qs(n,a,u,c,s,r,o))}),i.foreach((l,c)=>{const u=q(t,l);na(e,O(u))||(a=Qs(n,a,u,c,s,r,o))}),a}function ia(n,e,t){return t.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function Js(n,e,t,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;D(t)?c=i:c=new j(null).setTree(t,i);const u=e.serverCache.getNode();return c.children.inorderTraversal((d,h)=>{if(u.hasChild(d)){const f=e.serverCache.getNode().getImmediateChild(d),p=ia(n,f,h);l=Fi(n,l,new H(d),p,s,r,o,a)}}),c.children.inorderTraversal((d,h)=>{const f=!e.serverCache.isCompleteForChild(d)&&h.value===null;if(!u.hasChild(d)&&!f){const p=e.serverCache.getNode().getImmediateChild(d),m=ia(n,p,h);l=Fi(n,l,new H(d),m,s,r,o,a)}}),l}function cm(n,e,t,i,s,r,o){if(Li(s,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(D(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return Fi(n,e,t,l.getNode().getChild(t),s,r,a,o);if(D(t)){let c=new j(null);return l.getNode().forEachChild(Dt,(u,d)=>{c=c.set(new H(u),d)}),Js(n,e,t,c,s,r,a,o)}else return e}else{let c=new j(null);return i.foreach((u,d)=>{const h=q(t,u);l.isCompleteForPath(h)&&(c=c.set(u,l.getNode().getChild(h)))}),Js(n,e,t,c,s,r,a,o)}}function um(n,e,t,i,s){const r=e.serverCache,o=Kl(e,r.getNode(),r.isFullyInitialized()||D(t),r.isFiltered());return tc(n,o,t,i,ec,s)}function dm(n,e,t,i,s,r){let o;if(Li(i,t)!=null)return e;{const a=new Or(i,e,s),l=e.eventCache.getNode();let c;if(D(t)||O(t)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Mi(i,wt(e));else{const d=e.serverCache.getNode();g(d instanceof k,"serverChildren would be complete if leaf node"),u=Nr(i,d)}u=u,c=n.filter.updateFullNode(l,u,r)}else{const u=O(t);let d=Ar(i,u,e.serverCache);d==null&&e.serverCache.isCompleteForChild(u)&&(d=l.getImmediateChild(u)),d!=null?c=n.filter.updateChild(l,u,d,$(t),a,r):e.eventCache.getNode().hasChild(u)?c=n.filter.updateChild(l,u,k.EMPTY_NODE,$(t),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Mi(i,wt(e)),o.isLeafNode()&&(c=n.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||Li(i,F())!=null,In(e,c,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
