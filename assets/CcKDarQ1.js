 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wm=!0;function te(t,e=null){if(t===null)return C.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),m(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new oe(n,te(e))}if(!(t instanceof Array)&&wm){const n=[];let i=!1;if(ue(t,(o,a)=>{if(o.substring(0,1)!=="."){const l=te(a);l.isEmpty()||(i=i||!l.getPriority().isEmpty(),n.push(new D(o,l)))}}),n.length===0)return C.EMPTY_NODE;const r=Vi(n,hm,o=>o.name,Jr);if(i){const o=Vi(n,X.getCompare());return new C(r,te(e),new ze({".priority":o},{".priority":X}))}else return new C(r,te(e),ze.Default)}else{let n=C.EMPTY_NODE;return ue(t,(i,s)=>{if(We(t,i)&&i.substring(0,1)!=="."){const r=te(s);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(i,r))}}),n.updatePriority(te(e))}}pm(te);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Em extends fs{constructor(e){super(),this.indexPath_=e,m(!O(e)&&P(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,n){const i=this.extractChild(e.node),s=this.extractChild(n.node),r=i.compareTo(s);return r===0?Ht(e.name,n.name):r}makePost(e,n){const i=te(e),s=C.EMPTY_NODE.updateChild(this.indexPath_,i);return new D(n,s)}maxPost(){const e=C.EMPTY_NODE.updateChild(this.indexPath_,ri);return new D(Mt,e)}toString(){return Hn(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class km{constructor(){this.rootNode_=C.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,n){this.rootNode_=this.rootNode_.updateChild(e,n)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zi(){return{value:null,children:new Map}}function _n(t,e,n){if(O(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const i=P(e);t.children.has(i)||t.children.set(i,zi());const s=t.children.get(i);e=z(e),_n(s,e,n)}}function hr(t,e){if(O(e))return t.value=null,t.children.clear(),!0;if(t.value!==null){if(t.value.isLeafNode())return!1;{const n=t.value;return t.value=null,n.forEachChild(X,(i,s)=>{_n(t,new $(i),s)}),hr(t,e)}}else if(t.children.size>0){const n=P(e);return e=z(e),t.children.has(n)&&hr(t.children.get(n),e)&&t.children.delete(n),t.children.size===0}else return!0}function fr(t,e,n){t.value!==null?n(e,t.value):Am(t,(i,s)=>{const r=new $(e.toString()+"/"+i);fr(s,r,n)})}function Am(t,e){t.children.forEach((n,i)=>{e(i,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e,n){this.source=e,this.path=n,this.type=Pe.LISTEN_COMPLETE}operationForChild(e){return O(this.path)?new zn(this.source,F()):new zn(this.source,z(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ft{constructor(e,n,i){this.source=e,this.path=n,this.snap=i,this.type=Pe.OVERWRITE}operationForChild(e){return O(this.path)?new Ft(this.source,F(),this.snap.getImmediateChild(e)):new Ft(this.source,z(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=Pe.MERGE}operationForChild(e){if(O(this.path)){const n=this.children.subtree(new $(e));return n.isEmpty()?null:n.value?new Ft(this.source,F(),n.value):new on(this.source,F(),n)}else return m(P(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new on(this.source,z(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ne{constructor(e){this.writeTree_=e}static empty(){return new Ne(new G(null))}}function Ln(t,e,n){if(O(e))return new Ne(new G(n));{const i=t.writeTree_.findRootMostValueAndPath(e);if(i!=null){const s=i.path;let r=i.value;const o=me(s,e);return r=r.updateChild(o,n),new Ne(t.writeTree_.set(s,r))}else{const s=new G(n),r=t.writeTree_.setTree(e,s);return new Ne(r)}}}function pr(t,e,n){let i=t;return ue(n,(s,r)=>{i=Ln(i,J(e,s),r)}),i}function Ta(t,e){if(O(e))return Ne.empty();{const n=t.writeTree_.setTree(e,new G(null));return new Ne(n)}}function _r(t,e){return Wt(t,e)!=null}function Wt(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(me(n.path,e)):null}function Sa(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(X,(i,s)=>{e.push(new D(i,s))}):t.writeTree_.children.inorderTraversal((i,s)=>{s.value!=null&&e.push(new D(i,s.value))}),e}function dt(t,e){if(O(e))return t;{const n=Wt(t,e);return n!=null?new Ne(new G(n)):new Ne(t.writeTree_.subtree(e))}}function gr(t){return t.writeTree_.isEmpty()}function an(t,e){return zc(F(),t.writeTree_,e)}function zc(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let i=null;return e.children.inorderTraversal((s,r)=>{s===".priority"?(m(r.value!==null,"Priority writes must always be leaf nodes"),i=r.value):n=zc(J(t,s),r,n)}),!n.getChild(t).isEmpty()&&i!==null&&(n=n.updateChild(J(t,".priority"),i)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xi;function yv(t){m(!Xi,"__referenceConstructor has already been defined"),Xi=t}function wv(){return m(Xi,"Reference.ts has not been loaded"),Xi}let Ev=1;class Da{constructor(e){this.listenProvider_=e,this.syncPointTree_=new G(null),this.pendingWriteTree_=Qm(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function bv(t,e,n,i,s){return Um(t.pendingWriteTree_,e,n,i,s),s?gn(t,new Ft(eo(),e,n)):[]}function Iv(t,e,n,i){Bm(t.pendingWriteTree_,e,n,i);const s=G.fromObject(n);return gn(t,new on(eo(),e,s))}function Ot(t,e,n=!1){const i=$m(t.pendingWriteTree_,e);if(Hm(t.pendingWriteTree_,e)){let r=new G(null);return i.snap!=null?r=r.set(F(),!0):ue(i.children,o=>{r=r.set(new $(o),!0)}),gn(t,new qi(i.path,r,n))}else return[]}function oi(t,e,n){return gn(t,new Ft(to(),e,n))}function Cv(t,e,n){const i=G.fromObject(n);return gn(t,new on(to(),e,i))}function Tv(t,e){return gn(t,new zn(to(),e))}function Sv(t,e,n){const i=ao(t,n);if(i){const s=lo(i),r=s.path,o=s.queryId,a=me(r,e),l=new zn(no(o),a);return co(t,r,l)}else return[]}function Zi(t,e,n,i,s=!1){const r=e._path,o=t.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||iu(o,e))){const l=vv(o,e,n,i);gv(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const u=c.findIndex(h=>h._queryParams.loadsAllData())!==-1,d=t.syncPointTree_.findOnPath(r,(h,f)=>mt(f));if(u&&!d){const h=t.syncPointTree_.subtree(r);if(!h.isEmpty()){const f=Rv(h);for(let p=0;p<f.length;++p){const g=f[p],v=g.query,I=lu(t,g);t.listenProvider_.startListening(xn(v),qn(t,v),I.hashFn,I.onComplete)}}}!d&&c.length>0&&!i&&(u?t.listenProvider_.stopListening(xn(e),null):c.forEach(h=>{const f=t.queryToTagMap.get(ms(h));t.listenProvider_.stopListening(xn(h),f)}))}Pv(t,c)}return a}function su(t,e,n,i){const s=ao(t,i);if(s!=null){const r=lo(s),o=r.path,a=r.queryId,l=me(o,e),c=new Ft(no(a),l,n);return co(t,o,c)}else return[]}function kv(t,e,n,i){const s=ao(t,i);if(s){const r=lo(s),o=r.path,a=r.queryId,l=me(o,e),c=G.fromObject(n),u=new on(no(a),l,c);return co(t,o,u)}else return[]}function yr(t,e,n,i=!1){const s=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(s,(h,f)=>{const p=me(h,s);r=r||ht(f,p),o=o||mt(f)});let a=t.syncPointTree_.get(s);a?(o=o||mt(a),r=r||ht(a,F())):(a=new Zc,t.syncPointTree_=t.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=C.EMPTY_NODE,t.syncPointTree_.subtree(s).foreachChild((f,p)=>{const g=ht(p,F());g&&(r=r.updateImmediateChild(f,g))}));const c=iu(a,e);if(!c&&!e._queryParams.loadsAllData()){const h=ms(e);m(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const f=Nv();t.queryToTagMap.set(h,f),t.tagToQueryMap.set(f,h)}const u=_s(t.pendingWriteTree_,s);let d=mv(a,e,n,u,r,l);if(!c&&!o&&!i){const h=nu(a,e);d=d.concat(Ov(t,e,h))}return d}function ru(t,e,n){const s=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=me(o,e),c=ht(a,l);if(c)return c});return Gc(s,e,r,n,!0)}function Av(t,e){const n=e._path;let i=null;t.syncPointTree_.foreachOnPath(n,(c,u)=>{const d=me(c,n);i=i||ht(u,d)});let s=t.syncPointTree_.get(n);s?i=i||ht(s,F()):(s=new Zc,t.syncPointTree_=t.syncPointTree_.set(n,s));const r=i!=null,o=r?new gt(i,!0,!1):null,a=_s(t.pendingWriteTree_,e._path),l=eu(s,e,a,r?o.getNode():C.EMPTY_NODE,r);return uv(l)}function gn(t,e){return ou(e,t.syncPointTree_,null,_s(t.pendingWriteTree_,F()))}function ou(t,e,n,i){if(O(t.path))return au(t,e,n,i);{const s=e.get(F());s!=null&&(n=ht(s,F()));let r=[];const o=P(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const u=Kc(i,o);r=r.concat(ou(a,l,null,u))}return s&&(r=r.concat(oo(s,t,i,n))),r}}function au(t,e,n,i){const s=e.get(F());s!=null&&(n=ht(s,F()));let r=[];return e.children.inorderTraversal((o,a)=>{const c=Kc(i,o),u=t.operationForChild(o);u&&(r=r.concat(au(u,a,null,c)))}),s&&(r=r.concat(oo(s,t,i,n))),r}function lu(t,e){const n=e.query,i=qn(t,n);return{hashFn:()=>(cv(e)||C.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?Sv(t,n._path,i):Tv(t,n._path);{const r=Cg(s,n);return Zi(t,n,null,r)}}}}function qn(t,e){const n=ms(e);return t.queryToTagMap.get(n)}function ms(t){return t._path.toString()+"$"+t._queryIdentifier}function ao(t,e){return t.tagToQueryMap.get(e)}function lo(t){const e=t.indexOf("$");return m(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new $(t.substr(0,e))}}function co(t,e,n){const i=t.syncPointTree_.get(e);m(i,"Missing sync point for query tag that we're tracking");const s=_s(t.pendingWriteTree_,e);return oo(i,n,s,null)}function Rv(t){return t.fold((e,n,i)=>{if(n&&mt(n))return[gs(n)];{let s=[];return n&&(s=tu(n)),ue(i,(r,o)=>{s=s.concat(o)}),s}})}function xn(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(wv())(t._repo,t._path):t}function Pv(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const s=ms(i),r=t.queryToTagMap.get(s);t.queryToTagMap.delete(s),t.tagToQueryMap.delete(r)}}}function Nv(){return Ev++}function Ov(t,e,n){const i=e._path,s=qn(t,e),r=lu(t,n),o=t.listenProvider_.startListening(xn(e),s,r.hashFn,r.onComplete),a=t.syncPointTree_.subtree(i);if(s)m(!mt(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,d)=>{if(!O(c)&&u&&mt(u))return[gs(u).query];{let h=[];return u&&(h=h.concat(tu(u).map(f=>f.query))),ue(d,(f,p)=>{h=h.concat(p)}),h}});for(let c=0;c<l.length;++c){const u=l[c];t.listenProvider_.stopListening(xn(u),qn(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es=new ds("@firebase/auth");function Py(t,...e){es.logLevel<=W.WARN&&es.warn(`Auth (${fn}): ${t}`,...e)}function Ai(t,...e){es.logLevel<=W.ERROR&&es.error(`Auth (${fn}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
